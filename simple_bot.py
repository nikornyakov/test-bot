...
async def send_simple_poll():
    ...
    try:
        ...
        reminder = """
💡 Подсказка: Так как опрос неанонимный, вы можете видеть, кто планирует прийти, прямо в результатах опроса.

Завтра утром я пришлю напоминание о тренировке!
        """
...
async def send_training_reminder():
    ...
    try:
        ...
        reminder = f"""
🏀 Напоминание о тренировке {training_day} в 19:00-20:30!
...
async def main():
    ...
    if day_of_week in [0, 2]:  # Понедельник или среда
